...
public class ContainerManager {
    ...
    private ContainerManager(Context context) {
        ...
        if (context.getPackageManager().hasSystemFeature(CMContextConstants.Features.CONTAINERS)
                && sService == null) {
    ...
    public IContainerManager getService() {
        ...
        IBinder b = ServiceManager.getService(CMContextConstants.CM_CONTAINER_MANAGER_SERVICE);
        if (b != null) {
